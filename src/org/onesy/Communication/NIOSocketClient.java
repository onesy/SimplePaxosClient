...
public class NIOSocketClient {
	 ...
	 * @throws IOException
	 */
	public void deletedsub(MsgBean msgBean) throws IOException {
	 ...
	 */
	public void pub(MsgBean msgBean) throws IOException {
		...
		try {
			...
			while (!done) {
				...
				while (it.hasNext()) {
					...
					if (key.isWritable()) {
						// 向套接字通道中写入数据
						sc.write(ByteBuffer.wrap(new String(MsgBean.DecodeToStr(msgBean)
								+ CfgCenter.ConnectEND
